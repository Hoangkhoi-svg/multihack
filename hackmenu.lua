...
local function DebugInfo(mode, content, value)
    ...
    if mode == "warn" then
        warn("[KoihxzTP DEBUG]:", content, value or "")
    elseif mode == "print" then
        print("[KoihxzTP DEBUG]:", content, value or "")
    else
        warn("[KoihxzTP DEBUG]: Invalid debug type.")
    end
end
...
ScreenGui.Name = "KoihxzTPGui"
ScreenGui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
ScreenGui.IgnoreGuiInset = true
ScreenGui.DisplayOrder = 999
ScreenGui.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui")
DebugInfo("print", "KoihxzTPGui created", ScreenGui.Name)
